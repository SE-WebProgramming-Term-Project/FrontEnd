...
function AdminPageMenuRegist() {
    ...
    const submit = () => {
        ...
        pizza.append("title", title);
        pizza.append("category", category);
        pizza.append("large", large);
        pizza.append("regular", regular);
        pizza.append("matarials", matarials);
                ...
                <div className="info-container">
                    <form>
                        <div className="alvolo-input">
                            <input type="text" value={title} placeholder="메뉴명" onFocus={onFocus} onBlur={onBlur} onChange={titleChange}></input>
                        </div>
                        <div className="alvolo-input">
                            <input type="text" value={tag} placeholder="태그" onFocus={onFocus} onBlur={onBlur} onChange={tagChange}></input>
                        </div>
                        <div className="alvolo-input">
                        ...
                        <div className="alvolo-input">
                            <input type="number" value={large} placeholder="라지 가격" onFocus={onFocus} onBlur={onBlur} onChange={largeChange}></input>
                        </div>
                        <div className="alvolo-input">
                            <input type="number" value={regular} placeholder="레귤러 가격" onFocus={onFocus} onBlur={onBlur} onChange={regularChange}></input>
                        </div>
                        <div className="alvolo-input">
